...
private func layoutableChild<V: View>(
    ...
    LayoutSystem.LayoutableChild(
        ...
        prepareForLayout: {
            node.prepareLayoutWithNewView(view)
        },
        layoutState: {
            LayoutSystem.LayoutableChild.LayoutState(
...
extension TupleView1: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
        return LayoutInputKeys.make(
            Self.self,
            values: childKeys.map { $0! }
        )
    }
}


extension TupleView1: TransitionTraitProvider {
    var transitionTrait: AnyTransition? {
        (view0 as? TransitionTraitProvider)?.transitionTrait
    }
}
...
extension TupleView2: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView3: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            LayoutInputKeys.key(for: view2),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView4: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            LayoutInputKeys.key(for: view2),
            LayoutInputKeys.key(for: view3),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView5: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView6: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView7: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView8: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView9: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView10: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
...
extension TupleView11: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view8),
            LayoutInputKeys.key(for: view9),
            LayoutInputKeys.key(for: view10),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView12: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view9),
            LayoutInputKeys.key(for: view10),
            LayoutInputKeys.key(for: view11),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView13: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view10),
            LayoutInputKeys.key(for: view11),
            LayoutInputKeys.key(for: view12),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView14: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view11),
            LayoutInputKeys.key(for: view12),
            LayoutInputKeys.key(for: view13),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView15: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view12),
            LayoutInputKeys.key(for: view13),
            LayoutInputKeys.key(for: view14),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView16: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view13),
            LayoutInputKeys.key(for: view14),
            LayoutInputKeys.key(for: view15),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView17: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view14),
            LayoutInputKeys.key(for: view15),
            LayoutInputKeys.key(for: view16),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView18: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view15),
            LayoutInputKeys.key(for: view16),
            LayoutInputKeys.key(for: view17),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView19: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view16),
            LayoutInputKeys.key(for: view17),
            LayoutInputKeys.key(for: view18),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
...
extension TupleView20: LayoutInputKeyProvider {
    var layoutInputKey: AnyHashable? {
        let childKeys = [
            LayoutInputKeys.key(for: view0),
            LayoutInputKeys.key(for: view1),
            ...
            LayoutInputKeys.key(for: view17),
            LayoutInputKeys.key(for: view18),
            LayoutInputKeys.key(for: view19),
        ]
        guard childKeys.allSatisfy({ $0 != nil }) else {
            return nil
        }
